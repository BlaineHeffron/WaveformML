    ...
    for coord in coords:
        if coord[2] != last_id:
            if last_id > -1:
                ...
                out_stats[3, current_ind], out_stats[4, current_ind], out_stats[5, current_ind] = moment(times, weights=pulse)
                out_stats[6, current_ind], out_stats[7, current_ind], out_stats[8, current_ind] = moment(pulse)
